...
#define CONFIG_GICD_BASE          0xe7000000
#define CONFIG_GICR_BASE          0xe7040000
...
#define CONFIG_RAMBANK_SIZE      MB(2)
#define CONFIG_RAMBANK_END       \
        (CONFIG_RAMBANK_ADDR + CONFIG_RAMBANK_SIZE)

#define CONFIG_DEVICEIO1_BASEADDR  0xe5088000
#define CONFIG_DEVICEIO1_SIZE      0x1000000
#define CONFIG_DEVICEIO1_END       \
        (CONFIG_DEVICEIO1_BASEADDR + CONFIG_DEVICEIO1_SIZE)

#define CONFIG_DEVICEIO2_BASEADDR  0xe7000000
#define CONFIG_DEVICEIO2_SIZE      0x1000000
