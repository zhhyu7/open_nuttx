  ...
  if (cpu == 1)
    {
      ...
      irq_attach(SAM_IRQ_SMP_CALL_1, arm_smp_call_handler, NULL);
      up_enable_irq(SAM_IRQ_SMP_CALL_1);
    }
...
int up_cpu_start(int cpu)
{
  ...
  irq_attach(SAM_IRQ_SMP_CALL_0, arm_smp_call_handler, NULL);
  up_enable_irq(SAM_IRQ_SMP_CALL_0);
