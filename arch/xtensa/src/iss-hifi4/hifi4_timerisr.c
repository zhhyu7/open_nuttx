/****************************************************************************
 * arch/xtensa/src/iss-hifi4/hifi4_timerisr.c
 *
...
static int hifi4_timerisr(int irq, void *regs, void *arg)
{
  uint32_t divisor;
  uint32_t compare;
  uint32_t diff;
...
void up_timer_initialize(void)
{
  ...
  irq_attach(HIFI4_IRQ_TIMER2, hifi4_timerisr, NULL);

  /* Enable the timer interrupt. */

  up_enable_irq(HIFI4_IRQ_TIMER2);
}
