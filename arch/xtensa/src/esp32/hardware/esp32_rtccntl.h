...
/* Description: {reg_sw_stall_procpu_c1[5:0]
...
/* Description: wait cycles in slow_clk_rtc before ULP-coprocessor /
 * touch controller start to work
 */
 ...
 *   1: power down XTAL at low level
 */
...
/* Description:
 *   0: external wakeup at low level
 *   1: external wakeup at high level
 */
 ...
 *   0: CK8M_D256_OUT is CK8M divided by 256
 */
...
/* Description: CK8M_D256_OUT divider.
 *   00: div128
 *   01: div256
 *   10: div512
 *   11: div1024
...
/* Description: SW option for XPD_SDIO_REG.
...
/* Description: RTC_REG force power down (for RTC_REG power down
 *  means decreasethe voltage to 0.8v or lower )
 */
...
/* Description: 1: RTC memory  PD following CPU  0: RTC memory PD
 * following RTC state machine
 */
...
/* Description: 1: Fast RTC memory PD following CPU  0: fast RTC memory PD
 * following RTC state machine
 */
