# ##############################################################################
# cmake/nuttx_call_apps_makefile.cmake
#
...
add_custom_target(
  ...
  SOURCES ${CMAKE_SOURCE_DIR}/tools/mkdeps.c)

add_custom_target(
  incdir
  COMMAND cmake -B ${CMAKE_BINARY_DIR}/bin -S ${CMAKE_SOURCE_DIR}/tools && cmake
          --build ${CMAKE_BINARY_DIR}/bin --target incdir
  SOURCES ${CMAKE_SOURCE_DIR}/tools/incdir.c
  DEPENDS mkdeps)
...
function(generate_common_defs)
  ...
  set(MAKE_DEFS
    [=[
      ...
      EXTRAFLAGS += -I @CMAKE_BINARY_DIR@/include_arch
